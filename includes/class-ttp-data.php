    ...
    */
    ...
    private static function vendors_need_resolution( $vendors ) {
        ...
        foreach ( (array) $vendors as $vendor ) {
            ...
            $fields = array( 'domain', 'regions', 'categories', 'sub_categories', 'capabilities', 'hosted_type', 'parent_category', 'vendor' );
    ...
    public static function refresh_vendor_cache() {
        ...
        foreach ($records as $record) {
            ...
            $category_names = array_filter( array_merge( $parent_category ? array( $parent_category ) : array(), $categories, $sub_categories ) );
