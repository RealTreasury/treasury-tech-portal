...
<div class="wrap treasury-portal-admin">
    ...
    <h3><?php esc_html_e('Category Intro Videos', 'treasury-tech-portal'); ?></h3>
    <?php if (!empty($category_videos)) : ?>
        <table class="widefat striped">
            ...
            <tbody>
                <?php foreach ($category_videos as $i => $video) : ?>
                    <tr>
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
        ...
        <table class="form-table">
            <tr>
                <th scope="row"><label for="category_intro_video_url"><?php esc_html_e('Video URL', 'treasury-tech-portal'); ?></label></th>
                <td><input name="video_url" type="url" id="category_intro_video_url" class="regular-text" required /></td>
            </tr>
            <tr>
                <th scope="row"><label for="category_intro_video_region"><?php esc_html_e('Region', 'treasury-tech-portal'); ?></label></th>
                <td>
                    <select name="region" id="category_intro_video_region">
            ...
            <tr>
                <th scope="row"><label for="category_intro_video_category"><?php esc_html_e('Category', 'treasury-tech-portal'); ?></label></th>
                <td>
                    <select name="category" id="category_intro_video_category">
                        <option value=""><?php esc_html_e('Any', 'treasury-tech-portal'); ?></option>
    ...
    <h3><?php esc_html_e('Subcategory Intro Videos', 'treasury-tech-portal'); ?></h3>
    <?php if (!empty($subcategory_videos)) : ?>
        <table class="widefat striped">
            <thead>
                <tr>
                    <th><?php esc_html_e('Video URL', 'treasury-tech-portal'); ?></th>
            ...
            <tbody>
                <?php foreach ($subcategory_videos as $i => $video) : ?>
                    <tr>
                        <td><?php echo esc_url($video['url'] ?? ''); ?></td>
                        <td><?php echo esc_html($video['region'] ?? ''); ?></td>
                        <td><?php echo esc_html($categories[$video['category']] ?? $video['category'] ?? ''); ?></td>
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
        ...
        <table class="form-table">
            <tr>
                <th scope="row"><label for="subcategory_intro_video_url"><?php esc_html_e('Video URL', 'treasury-tech-portal'); ?></label></th>
                <td><input name="video_url" type="url" id="subcategory_intro_video_url" class="regular-text" required /></td>
            </tr>
            <tr>
                <th scope="row"><label for="subcategory_intro_video_region"><?php esc_html_e('Region', 'treasury-tech-portal'); ?></label></th>
                <td>
                    <select name="region" id="subcategory_intro_video_region">
                        <option value=""><?php esc_html_e('Any', 'treasury-tech-portal'); ?></option>
                        <?php foreach ($regions as $region) : ?>
                            <option value="<?php echo esc_attr($region); ?>"><?php echo esc_html($region); ?></option>
                        <?php endforeach; ?>
            ...
            <tr>
                <th scope="row"><label for="subcategory_intro_video_category"><?php esc_html_e('Category', 'treasury-tech-portal'); ?></label></th>
                <td>
                    <select name="category" id="subcategory_intro_video_category">
                        <option value=""><?php esc_html_e('Any', 'treasury-tech-portal'); ?></option>
                        <?php foreach ($categories as $key => $label) : ?>
                            <option value="<?php echo esc_attr($key); ?>"><?php echo esc_html($label); ?></option>
                        <?php endforeach; ?>
            ...
            <tr>
                <th scope="row"><label for="subcategory_intro_video_sub_category"><?php esc_html_e('Sub Category', 'treasury-tech-portal'); ?></label></th>
                <td>
                    <select name="sub_category" id="subcategory_intro_video_sub_category">
                        <option value=""><?php esc_html_e('Any', 'treasury-tech-portal'); ?></option>
