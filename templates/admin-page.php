            ...
            <table class="widefat fixed striped treasury-portal-admin-table">
                ...
                <?php foreach ($vendors as $vendor) : ?>
                    ...
                    <tr>
                        ...
                        <td data-label="<?php echo esc_attr__('Website', 'treasury-tech-portal'); ?>" data-filter-value="<?php echo esc_attr($website); ?>">
                            <?php if (!empty($website_href)) : ?>
                                <a href="<?php echo $website_href; ?>" target="_blank" rel="noopener noreferrer" data-filter-value="<?php echo esc_attr($website); ?>"><?php echo $website_text; ?></a>
                            <?php endif; ?>
                        </td>
                        <td data-label="<?php echo esc_attr__('Video URL', 'treasury-tech-portal'); ?>" data-filter-value="<?php echo esc_attr($video_url); ?>">
                            <?php if (!empty($video_href)) : ?>
                                <a href="<?php echo $video_href; ?>" target="_blank" rel="noopener noreferrer" data-filter-value="<?php echo esc_attr($video_url); ?>"><?php echo $video_text; ?></a>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="is-mobile-hidden" data-label="<?php echo esc_attr__('Logo URL', 'treasury-tech-portal'); ?>" data-filter-value="<?php echo esc_attr($logo_url); ?>">
                            <?php if (!empty($logo_href)) : ?>
                                <a href="<?php echo $logo_href; ?>" target="_blank" rel="noopener noreferrer" data-filter-value="<?php echo esc_attr($logo_url); ?>"><?php echo $logo_text; ?></a>
                            <?php endif; ?>
                        </td>
